...
-- CreateEnum
CREATE TYPE "MovementType" AS ENUM ('STOCK_IN', 'STOCK_OUT', 'ADJUSTMENT', 'SALE', 'RETURN', 'RESERVE', 'UNRESERVE');

-- CreateEnum
CREATE TYPE "ReferenceType" AS ENUM ('ORDER', 'MANUAL', 'SYSTEM', 'RETURN');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER_CREATED', 'ORDER_STATUS_CHANGED', 'PAYMENT_RECEIVED', 'SHIPPING_UPDATED', 'RETURN_REQUESTED', 'RETURN_APPROVED', 'RETURN_REJECTED');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('CREATE', 'UPDATE', 'DELETE', 'LOGIN_SUCCESS', 'LOGIN_FAILED', 'LOGOUT', 'STATUS_CHANGE', 'PERMISSION_CHANGE', 'PAYMENT_CHANGE', 'STOCK_ADJUSTMENT');
...
CREATE TABLE "InventoryMovement" (
    ...
    "reservedChange" INTEGER NOT NULL,
    "reason" TEXT,
...
CREATE TABLE "ReturnItem" (
    ...
    "isLastAdjustment" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductVariant_productId_optionsHash_key" ON "ProductVariant"("productId", "optionsHash");
...
-- CreateIndex
CREATE INDEX "ReservationItem_variantId_idx" ON "ReservationItem"("variantId");

-- CreateIndex
CREATE UNIQUE INDEX "ReservationItem_reservationId_variantId_key" ON "ReservationItem"("reservationId", "variantId");
...
-- CreateIndex
CREATE UNIQUE INDEX "ShippingZoneCity_cityNormalized_key" ON "ShippingZoneCity"("cityNormalized");

-- CreateIndex
CREATE INDEX "ShippingZoneCity_shippingZoneId_idx" ON "ShippingZoneCity"("shippingZoneId");

-- CreateIndex
CREATE INDEX "ShippingZoneCity_cityNormalized_idx" ON "ShippingZoneCity"("cityNormalized");
...
-- AddForeignKey
ALTER TABLE "ReservationItem" ADD CONSTRAINT "ReservationItem_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "ProductVariant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShippingZoneCity" ADD CONSTRAINT "ShippingZoneCity_shippingZoneId_fkey" FOREIGN KEY ("shippingZoneId") REFERENCES "ShippingZone"("id") ON DELETE CASCADE ON UPDATE CASCADE;
